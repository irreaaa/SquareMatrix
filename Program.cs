...
Console.WriteLine("Введите минимальное значение случаных чисел: ");
int min = Convert.ToInt32(Console.ReadLine());

Console.WriteLine("Введите максимальное значение случаных чисел: ");
...
Console.WriteLine("Выичтание матрицы Б из матрицы А"); for (i = 0; i < n; i++)
{
    for (int j = 0; j < n; j++)
    {
